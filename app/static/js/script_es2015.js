...
var Ship = function () {
  function Ship(ship_size, ship_id) {
    ...
    this.coords_hit = 0;
    for (var i = 0; i < this.ship_size; i++) {
  ...
  _createClass(Ship, [{
    ...
    value: function save_coords(x, y) {
    ...
    value: function check_coords(x, y) {
    ...
    key: 'prevent_touch',
    value: function prevent_touch(game_board) {
    ...
    value: function hit(coords, room) {
